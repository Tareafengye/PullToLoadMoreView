...
public class TwoFragment extends Fragment {
    ...
    private void initView() {
        MyGoodsScrollView twoScrollView= (MyGoodsScrollView) mView.findViewById(R.id.twoScrollview);
        twoScrollView.setScrollListener(new MyGoodsScrollView.ScrollListener() {
            @Override
